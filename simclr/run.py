...
def generate_csv(args):
    ...
    if args.multiscale==0:
        ...
        path_temp = os.path.join( args.dataset,'*', '*', '*.png')
        patch_path = glob.glob(path_temp) # /class_name/bag_name/*.jpeg
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='Oral_10_20', help='Dataset folder name')
    args = parser.parse_args()
    config = yaml.load(open("/home/karan.padariya/dsmil-wsi/simclr/config.yaml", "r"), Loader=yaml.FullLoader)
